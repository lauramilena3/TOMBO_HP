...
# Read counts
	...
	for index,row in sample_sheet.iterrows():
		...
		inputs.extend(expand(dirs_dict["PLOTS_DIR"] + "/{genome}/sampleCompare_{genome}_{sample}_{control}_histogram_dinucleotide.pdf", sample=row_sample, control=row_control, genome=row_genome)),
		inputs.extend(expand(dirs_dict["PLOTS_DIR"] + "/{genome}/denovo_{genome}_{sample}_histogram_dinucleotide.pdf", sample=row_sample, genome=row_genome)),
	return inputs
...
rule parse_tombo_results_sampleCompare:
	...
	output:
		modfrac_png= dirs_dict["PLOTS_DIR"] + "/{genome}/sampleCompare_{genome}_{sample}_{control}_per_base_modfrac_10000.pdf",
		modfrac_kmers_table= dirs_dict["PLOTS_DIR"] + "/{genome}/sampleCompare_{genome}_{sample}_{control}_kmer_modfrac.csv",
		coverage_png= dirs_dict["PLOTS_DIR"] + "/{genome}/sampleCompare_{genome}_{sample}_{control}_per_base_coverage.pdf",
		dinucleotide= dirs_dict["PLOTS_DIR"] + "/{genome}/sampleCompare_{genome}_{sample}_{control}_histogram_dinucleotide.pdf",
		trinucleotide= dirs_dict["PLOTS_DIR"] + "/{genome}/sampleCompare_{genome}_{sample}_{control}_histogram_trinucleotide.pdf",
		tetranucleotide= dirs_dict["PLOTS_DIR"] + "/{genome}/sampleCompare_{genome}_{sample}_{control}_histogram_tetranucleotide.pdf",
		pentanucleotide= dirs_dict["PLOTS_DIR"] + "/{genome}/sampleCompare_{genome}_{sample}_{control}_histogram_pentanucleotide.pdf",
		# hexanucleotide= dirs_dict["PLOTS_DIR"] + "/{genome}/sampleCompare_{genome}_{sample}_{control}_histogram_hexanucleotide.pdf",
	params:
...
rule parse_tombo_results_deNovo:
	...
	output:
		modfrac_png= dirs_dict["PLOTS_DIR"] + "/{genome}/denovo_{genome}_{sample}_per_base_modfrac_10000.pdf",
		modfrac_kmers_table= dirs_dict["PLOTS_DIR"] + "/{genome}/denovo_{genome}_{sample}_kmer_modfrac.csv",
		coverage_png= dirs_dict["PLOTS_DIR"] + "/{genome}/denovo_{genome}_{sample}_per_base_coverage.pdf",
		dinucleotide= dirs_dict["PLOTS_DIR"] + "/{genome}/denovo_{genome}_{sample}_histogram_dinucleotide.pdf",
		trinucleotide= dirs_dict["PLOTS_DIR"] + "/{genome}/denovo_{genome}_{sample}_histogram_trinucleotide.pdf",
		tetranucleotide= dirs_dict["PLOTS_DIR"] + "/{genome}/denovo_{genome}_{sample}_histogram_tetranucleotide.pdf",
		pentanucleotide= dirs_dict["PLOTS_DIR"] + "/{genome}/denovo_{genome}_{sample}_histogram_pentanucleotide.pdf",
		# hexanucleotide= dirs_dict["PLOTS_DIR"] + "/{genome}/denovo_{genome}_{sample}_histogram_hexanucleotide.pdf",
	params:
		tombo_dir=dirs_dict["TOMBO"],
		figdir=dirs_dict["PLOTS_DIR"],
		genome="{genome}",
