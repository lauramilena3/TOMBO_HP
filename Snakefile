...
rule tombo_denovo:
	...
	shell:
		...
		tombo text_output signif_sequence_context --statistics-filename {params.stats} --genome-fasta {input.genome} --num-regions 1000 --num-bases 10 --sequences-filename {params.significant}
		meme -oc {params.meme} -dna -mod zoops {params.significant} -nmotifs 20 -minw 2 -maxw 10 -allw -maxsites 100
		"""
