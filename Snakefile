...
rule tombo:
	...
	shell:
		...
		tombo resquiggle --processes 40 --overwrite {input.control} {input.genome} --processes {threads}
		tombo resquiggle --processes 40 --overwrite {input.sample} {input.genome} --processes {threads}
